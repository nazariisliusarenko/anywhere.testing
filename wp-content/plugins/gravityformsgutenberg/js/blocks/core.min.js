...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ruleset___ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rule___ = __webpack_require__(22);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var baseMatches = __webpack_require__(44),
    baseMatchesProperty = __webpack_require__(108),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_find__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_conditional_logic___ = __webpack_require__(20);
...
registerBlockType('gravityforms/block', {
	...
	icon: function icon() {
		return React.createElement(
			'svg',
			{ xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 508.3 559.5', width: '20px', height: '20px',
	...
	edit: function (_Component) {
		...
		function edit() {
			...
			var form = _this.getForm(_this.props.attributes.formId);
			if (form && form.hasConditionalLogic) {
				_this.props.setAttributes({ formPreview: false });
			}
		...
		_createClass(edit, [{
			...
			value: function getForm(formId) {
				...
				return __WEBPACK_IMPORTED_MODULE_0_lodash_find___default()(gform.forms, function (f) {
					return f.id == formId;
				});
			}
		}, {
			...
			value: function getFormOptions() {
				...
				for (var i = 0; i < gform.forms.length; i++) {
					options.push({
						label: gform.forms[i].title,
						value: gform.forms[i].id
					});
				}
			...
			value: function render() {
				...
				var setFormIdFromPlaceholder = function setFormIdFromPlaceholder(e) {
					return _this2.setFormId(e.target.value);
				};
				...
				var controls = [isSelected && React.createElement(
					...
					React.createElement(
						...
						conditionalLogic.enabled && React.createElement(__WEBPACK_IMPORTED_MODULE_1__components_conditional_logic___["a" /* default */], {
					...
					return [controls, React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								this.getFormOptions().map(function (form) {
									return React.createElement(
										'option',
	...
	save: function save(props) {
		...
		var shortcode = '[gravityform id="' + formId + '" title="' + (title ? 'true' : 'false') + '" description="' + (description ? 'true' : 'false') + '" ajax="' + (ajax ? 'true' : 'false') + '" tabindex="' + (tabindex ? tabindex : 0) + '"]';

		return formId ? { shortcode: shortcode } : null;
	}
