...
Theme URI: http://themes.themegoods.com/grandconference
Author: ThemeGoods
...
function grandconference_add_admin() 
{
	...
	if ( isset($_GET['page']) && $_GET['page'] == 'functions.php' ) {
		...
		if ( isset($_REQUEST['action']) && 'save' == $_REQUEST['action'] ) {
			...
			if(isset($_REQUEST['pp_envato_personal_token']) && !empty($_REQUEST['pp_envato_personal_token']) && $_REQUEST['pp_envato_personal_token'] != '[ThemeGoods Activation]')
			{
				...
				{
					$is_verified_envato_purchase_code = false;
					delete_option("pp_verified_envato_grandconference", true);
				}
	...
	add_theme_page('Theme Setting', 'Theme Setting', 'administrator', 'functions.php', 'grandconference_admin', '');
}
...
add_action('wp_ajax_nopriv_grandconference_import_demo_content', 'grandconference_import_demo_content');
	    ...
	    { 
	    	switch($_POST['demo'])
	    	{
		    	...
		    	default:
		    		...
		    		$oldurl = 'http://themes.themegoods.com/grandconference/demo';
		    	break;
		    	...
		    	case 2:
		    		...
		    		$oldurl = 'http://themes.themegoods.com/grandconference/demo2';
		    	break;
		    	...
		    	case 3:
		    		...
		    		$oldurl = 'http://themes.themegoods.com/grandconference/demo3';
		    	break;
	    	}
...
add_action('wp_ajax_nopriv_grandconference_get_styling', 'grandconference_get_styling');
